...
function Register() {
  ...
  <section className='form'>
    <form onSubmit={onSubmit}>
      ...
      <div className="form-group"><input type="text" className="form-control" id='password2' name='password2' value={password2} placeholder='Enter your password again' onChange={onChange}/></div>

      <div className="form-group"><input type="text" className="form-control" id='role' name='role' value={role} placeholder='Enter your role' onChange={onChange}/></div>
